...
<head>
    ...
    <style>
        /* Custom CSS untuk gambar latar belakang */
        .masthead {
        ...
        .navbar-brand {
            color: #ffd700 !important; /* Warna kuning */
        }
        ...
        /* Tambahkan efek border warna hijau pada tombol saat diklik */
        .navbar-nav .nav-link.active,
        .navbar-nav .nav-link:active {
            border-bottom: 2px solid #00FF00; /* Warna hijau */
        }
        ...
        #partner h2 {
            color: #000 !important; /* Warna kuning */
        }
...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#partner">Project</a></li>
    ...
    <section class="page-section portfolio" id="partner">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-6">My Project</h2>
            <!-- Icon Divider-->
    ...
    <footer class="footer text-center" id="profile">
        <div class="container">
            <div class="row">
                ...
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <h4 class="text-uppercase mb-4">Contact Me On Social Media</h4>
                    @if ($youtube)
                    ...
                    @if ($whatsapp)
                    <a class="btn btn-outline-light btn-social mx-1" href="{{$whatsapp}}"target="blank"><i class="fab fa-fw fa-whatsapp-f"></i></a>
                    @endif
